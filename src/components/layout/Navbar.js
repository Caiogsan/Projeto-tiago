    ...
    return (
        <div className="absolute bg-transparent h-20 w-[100%] px-12 pt-6 md:px-16 lg:px-20 p-4">
            <div className="flex justify-between w-[100%]">
                <div className=" w-[30%] md:w-[20%] items-center flex">
                ...
                <div className="w-[70%] md:w-[80%] font-principal text-sm md:text-lg pl-12 lg:text-xl flex justify-between text-white  items-center">
